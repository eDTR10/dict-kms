export default function Footer() {
  return (
    <footer className="bg-[#0038A8] text-white mt-auto">
      <div className="h-1 bg-gradient-to-r from-[#CE1126] via-[#FCD116] to-[#CE1126]" />
      <div className="max-w-7xl mx-auto px-4 py-8 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            <h3 className="font-bold text-sm uppercase tracking-wider text-[#FCD116] mb-2">Quick Links</h3>
          ...
          <div>
            <h3 className="font-bold text-sm uppercase tracking-wider text-[#FCD116] mb-2">Contact</h3>
